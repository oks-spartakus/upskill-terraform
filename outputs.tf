...
output "vpc_default_security_groupublic_route_table_idp_id" {
...
output "private_db_subnet_arns" {
  value       = aws_subnet.db_subnet_private.*.arn
  description = "The ARNs of the database private subnets."
}

output "private_db_subnet_cidr_blocks" {
  value       = aws_subnet.db_subnet_private.*.cidr_block
...
output "private_db_subnet_group_name" {
  value = aws_db_subnet_group.db_subnet_group_private.*.name
}
